...
if not LoadResourceFile(GetCurrentResourceName(), 'web/build/index.html') then
    print('^1[SD-WAYPOINTS] ERROR: web/build folder not found!^0')
    print('^1[SD-WAYPOINTS] You likely downloaded the source code instead of the release.^0')
    print('^1[SD-WAYPOINTS] Please download the latest release from: https://github.com/Samuels-Development/sd-waypoints/releases/latest^0')
    return
end
